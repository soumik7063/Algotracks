...
const LeetcodeContest = () => {
  ...
  const [bookmarked, setBookmarked] = useState({});
    ...
    const[leetcodeBookmark,setLeetcodeBookmark] = useState([])
  ...
  // }, [upcomingContest]);
  useEffect(() => {
   if(user && user.bookmarks && user.bookmarks["Leetcode"]){
    setLeetcodeBookmark(user.bookmarks["Leetcode"])
    console.log("Setted bookmarks: ",user.bookmarks["Leetcode"])
   }
  }, [user?.bookmarks?.['Leetcode']])
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <div className="md:flex">
                              ...
                              <div className="p-4 md:p-6 flex-1">
                                ...
                                <div className="flex justify-between">
                                  ...
                                  <div
                                    onClick={() =>
                                      updateBookmark(contest.titleSlug)
                                    }
                                    className="text-3xl font-bold cursor-pointer"
                                    style={{
                                      color: bookmarked[contest.titleSlug]
                                        ? "#FFD700"
                                        : "#808080",
                                    }}
                                  >
      ...
      <div className="mt-4 text-center text-sm text-gray-500">
        Data provided by Leetcode API. Last updated:{" "}
