...
const LeetcodeContest = () => {
  ...
  const {upcomingContest,pastContest,isLoadingLeetcode} = useContext(contestContext)
  ...
  useEffect(() => {
    if (user && user.bookmarks && user.bookmarks["Leetcode"]) {
      setbookmarkContest(user.bookmarks["Leetcode"]);
    }
                ...
                {upcomingContest && upcomingContest.length > 0 ? (
                  <div className="grid gap-6">
                    {upcomingContest
                      ...
                      .map((contest,idx) => {
                        return (
                          <ContestCard key={idx} contest={contest} updateBookmark={updateBookmark} isBookmarkLoading={isBookmarkLoading} bookmarked={bookmarked}/>
                        );
                      })}
                  </div>
                ) : (
